...
async function populate() {// Introducing JavaScript Object Notation (JSON): https://json.org/
...
// STEP 4b: Store the URL of a JSON file in a variable */
  const url = "https://mazzoccor.github.io/1073-JS/24W-JavaScript-LH-Week11-main/js/i-scream.json";
...
function showTopFlavors(jsonData){
    ...
    for(let i=0; i<topFlavors.length; i++){
        ...
        let arrticale = document.createElement("article");//<article></article>
        ...
        arrticale.appendChild(h2);
        arrticale.appendChild(p1);
        arrticale.appendChild(p2);
        arrticale.appendChild(image);
        arrticale.appendChild(list);

        section.appendChild(arrticale);
