...
class Coffee{
    ...
    serveIt(){
        ...
        cup.setAttribute('src', 'images/coffee-cup.svg');//<img src="images/coffee-cup.svg"> - For file path, level of the HTML, not the JS.
        ...
        switch(this.size){
            case 'small':
                ...
                break;
            case 'medium':
                cup.setAttribute('height', '150')//<img src="images/coffee-cup.svg" height=150>
                break;
            case 'large':
                cup.setAttribute('height', '200')//<img src="images/coffee-cup.svg" height=200>
                break;
        }  
...
let mazzCoffee = new Coffee('medium', false);
...
class Latte extends Coffee{
    ...
    latteDesc(){
        console.log(`A ${this.size} sized Latte with ${this.milkType} milk.`);
    }
}
/* STEP 6: Create a new instance of the Latte object */
let rebCoffee = new Latte('medium', false, '2%');
