...
function Cofee(size, isDecaf, cream, sugar) {
  this.size = size;
  this.isDecaf = isDecaf;
  this.cream = cream;
  this.sugar = sugar;
  this.decaffeinated = (this.isDecaf) ? 'decaffeinated' : 'caffeinated';
  this.description = function() {
    return `A ${this.size} coffee with ${this.cream} cream and ${this.sugar} sugar, ${this.decaffeinated}.`;
  };

}
/* STEP 2: Instatiate a coffee based on the above constructor function */
let mazzCoffee = new Cofee('large', false, 'no', 'no');
output.textContent = mazzCoffee.description();
...
let robertCoffee = Object.create(mazzCoffee);
robertCoffee.size = 'small';
robertCoffee.isDecaf = true;
robertCoffee.cream = '1';
robertCoffee.sugar = '1';

output.textContent = robertCoffee.description();
...
let meganCoffee = new robertCoffee.constructor('medium', false, '2', '2');
