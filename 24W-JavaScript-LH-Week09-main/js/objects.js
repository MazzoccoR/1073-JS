...
let person={
    ...
    greatings: function(){
        alert(`Hello ${this.name.first} ${this["name"]["last"]}, how are you today?`);//need to use ` insted of " or ' to use the {} in the string
    },
    bio: function(){
        return `The interests of ${this.name.first}, of age ${this.age}, of gender ${this.gender}. are ${this.interests}`;
    }
};
...
person.goodbye = function(){
    alert(`This is a ${this.name.first} singing off.`);
};
